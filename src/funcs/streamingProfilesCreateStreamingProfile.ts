...
import {
  ...
  StreamingProfileCreate$zodSchema,
} from "../models/streamingprofilecreate.js";
...
export function streamingProfilesCreateStreamingProfile(
  ...
  request: StreamingProfileCreate,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => StreamingProfileCreate$zodSchema.parse(value$),
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, CreateStreamingProfileResponse$zodSchema, {
