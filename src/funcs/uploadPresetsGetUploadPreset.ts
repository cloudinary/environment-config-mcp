...
export function uploadPresetsGetUploadPreset(
  ...
  request: GetUploadPresetRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetUploadPresetRequest$zodSchema.parse(value$),
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, GetUploadPresetResponse$zodSchema, {
      key: "upload_preset_detail",
    }),
