...
url = "${o}/sse"
http_headers = { "server-index" = "YOUR_SERVER_INDEX", "region" = "YOUR_REGION", "api-host" = "YOUR_API_HOST", "api-key" = "YOUR_API_KEY", "api-secret" = "YOUR_API_SECRET", "oauth2" = "YOUR_OAUTH2", "cloud-name" = "YOUR_CLOUD_NAME" }`;
      ...
      <div class="content-container">
            ...
            <div class="header-actions">
              ...
              <div class="popover">
                ...
                <div class="popover-menu hidden" id="popover-menu">
                  <a class="popover-button install-link" href="cursor://anysphere.cursor-deeplink/mcp/install?name=CloudinaryEnvConfig&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJtY3AiLCJzdGFydCIsIi0tc2VydmVyLWluZGV4IiwiMCIsIi0tcmVnaW9uIiwiYXBpIiwiLS1hcGktaG9zdCIsImFwaS5jbG91ZGluYXJ5LmNvbSIsIi0tYXBpLWtleSIsIiIsIi0tYXBpLXNlY3JldCIsIiIsIi0tb2F1dGgyIiwiIiwiLS1jbG91ZC1uYW1lIiwiIl19">
                    Cursor
                  </a>
                  ...
                  <a class="popover-button install-link" href="vscode://ms-vscode.vscode-mcp/install?name=CloudinaryEnvConfig&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJtY3AiLCJzdGFydCIsIi0tc2VydmVyLWluZGV4IiwiMCIsIi0tcmVnaW9uIiwiYXBpIiwiLS1hcGktaG9zdCIsImFwaS5jbG91ZGluYXJ5LmNvbSIsIi0tYXBpLWtleSIsIiIsIi0tYXBpLXNlY3JldCIsIiIsIi0tb2F1dGgyIiwiIiwiLS1jbG91ZC1uYW1lIiwiIl19">
                    VS Code
                  </a>
        ...
        <section class="install container">
          ...
          <div class="install-targets">
            <a tabindex="0" class="card install-target install-link" href="cursor://anysphere.cursor-deeplink/mcp/install?name=CloudinaryEnvConfig&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJtY3AiLCJzdGFydCIsIi0tc2VydmVyLWluZGV4IiwiMCIsIi0tcmVnaW9uIiwiYXBpIiwiLS1hcGktaG9zdCIsImFwaS5jbG91ZGluYXJ5LmNvbSIsIi0tYXBpLWtleSIsIiIsIi0tYXBpLXNlY3JldCIsIiIsIi0tb2F1dGgyIiwiIiwiLS1jbG91ZC1uYW1lIiwiIl19">
              <div class="target">
    ...
    <div class="modal" id="claude-code-modal">
      ...
      <div class="content-slot">
        ...
        <div class="code-container card">
          ...
          <code class="code-snippet language-json" id="claude-cli-cmd">claude mcp add CloudinaryEnvConfig -- npx -y mcp start --server-index 0 --region api --api-host api.cloudinary.com --api-key  --api-secret  --oauth2  --cloud-name </code>
        </div>
      </div>
    </div>
    ...
    <div class="modal" id="claude-desktop-modal">
      ...
      <div class="content-slot">
        ...
        <div class="instruction-item">
          <a href="https://github.com/cloudinary/environment-config-mcp/releases/download/v0.0.1/mcp-server.mcpb" download="mcp-server.mcpb" class="action-button header-action" style="display: inline-flex; margin-bottom: 16px;">
            📥 Download MCP Bundle
          </a>
        </div>
    ...
    <div class="modal" id="gemini-modal">
      ...
      <div class="content-slot">
        ...
        <div class="code-container card">
          ...
          <code class="code-snippet language-json" id="gemini-config">gemini mcp add CloudinaryEnvConfig -- npx -y mcp start --server-index 0 --region api --api-host api.cloudinary.com --api-key  --api-secret  --oauth2  --cloud-name </code>
        </div>
      </div>
    </div>
